...
public class ProjectTest {
	...
	@Test
	public void harrierModelTestisLoss() {
		HarrierModel hm = new HarrierModel();
		hm.getHarrier().setVision(30);
		assertEquals(hm.isLoss(), false);
		hm.getHarrier().setVision(0);
		assertEquals(hm.isLoss(), true);
	}
	...
	public void harrierModelTestUpdate() {
		...
		hm.update();
		assertEquals(hm.getStage(), Tutorial.TWO);
		hm.getHarrier().setXVel(1);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.THREE);
		hm.getHarrier().setYVel(1);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.FOUR);
		hm.getHarrier().setXVel(-1);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.FIVE);
		
		hm.getTwigs().remove(0);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.SIX);
		
		hm.getMice().remove(0);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.SEVEN);
		
		hm.getHarrier().setVision(Harrier.INITIAL_VISION);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.EIGHT);
		
		hm.getMice().remove(0);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.NINE);
		
		hm.getHarrier().setXPos(0);
		hm.update();
		assertEquals(hm.getStage(), Tutorial.NONE);
	...
	@Test
	public void ospreyModelTestisLoss() {
		OspreyModel om= new OspreyModel();
		
		om.getOsprey().setXVel(0);
		assertEquals(om.isLoss(), true);
	}
	...
	public void ospreyModelTestUpdate() {
		...
		om.update();
		assertEquals(om.getStage(), Tutorial.TWO);
		...
		om.update();
		assertEquals(om.getStage(), Tutorial.THREE);
